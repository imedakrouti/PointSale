...
class ClientController extends Controller
{
    ...
    public function index(Request $request)
    {
       ...
       if($request->table_search){
           $id=client::where('name','like',"%{$request->table_search}%")->value('id');
       }
       $clients=client::when($request->table_search,function($q) use($request){
        ...
        return view('dashboard.client.index')->with(['clients'=>$clients,'id'=>$id]);
    }

...
class CategoryController extends Controller
{
    ...
    {
        $categories=category::all('id')->with('products')->when($request->table_search, function ($query) use ($request) {
                return $query->whereTranslationLike('name', 'like', '%' . $request->table_search . '%');

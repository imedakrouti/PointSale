              ...
              <div class="card-body ">
                <form action="{{ route('dashboard.client.index')}}"method="GET">
                    <div class="row mb-3">
                      ...
                      <input type="text" name="date" class="form-control float-right mx-2 datepicker px-auto" data-date-format="yyyy-mm-dd" placeholder="@lang('site.search')"value="{{request()->date}}">
                      </div>
                      <div class="mx-2">
                    ...
                    <thead class="bg-primary">
                            ...
                            @foreach ($clients as $index=>$client)
                                <tr>
                                    ...
                                    <td><a href="{{ route('dashboard.product.index',['client_id'=>$client->id]) }}"class="btn btn-outline-warning">@lang('site.show_products')</a></td>
                                    @else
                                    <td><a href="{{ route('dashboard.product.index',['client_id'=>$client->id]) }}"class="btn btn-outline-warning disabled">@lang('site.show_products')</a></td>
                                    @endif
                                    <td>

                ...
                <form action="{{ route('dashboard.product.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    @endforeach
                     ...
                     <div class="form-group">
                        ...
                        <input type="number" name="purchase_price" class="form-control"value={{ old('purchase_price') }} min=0 step=0.1 >
                    </div>
                     <div class="form-group">
                        <label>@lang('site.sale_price')</label>
                        <input type="number" name="sale_price" class="form-control"value={{ old('sale_price') }}min=0 step=0.1>
                    </div>
                    <div class="form-group">
                        <label>@lang('site.stock')</label>
                        <input type="number" name="stock" class="form-control"value={{ old('stock') }}min=0 step=0.1>
                    </div>
                    </div>  <!-- /.card-body -->

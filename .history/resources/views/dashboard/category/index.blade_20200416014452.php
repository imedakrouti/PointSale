              ...
              <div class="card-body ">
                <form action="{{ route('dashboard.category.index')}}"method="GET">
                    <div class="row mb-3">
                      ...
                      <input type="text" name="date" class="form-control float-right mx-2 datepicker"   class="datepicker" data-date-format="mm/dd/yyyy"placeholder="@lang('site.search')"value="{{old('date')}}">
                      </div>
                      <div class="mx-2">
